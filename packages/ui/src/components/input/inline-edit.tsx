  ...
  "relative inline-flex items-center gap-2 transition-colors focus-within:outline-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-input hover:bg-accent hover:text-accent-foreground rounded-md border",
      },
      size: {
  ...
  (
    ...
    const renderInput = () => {
      const inputProps = {
        ...
        className: cn(
          "ring-offset-background placeholder:text-muted-foreground flex h-full w-full bg-transparent px-0 py-0 text-sm focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
